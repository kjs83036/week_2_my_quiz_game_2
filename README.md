...
* [ ] 숫자 입력 시 공백 제거
* [ ] 숫자 변환 실패 → 안내 메시지 출력 후 재입력
* [ ] 범위 밖 입력 → 안내 메시지 출력 후 재입력
* [ ] 빈 입력 처리 → 안내 메시지 출력 후 재입력
* [ ] Ctrl+C / EOFError 안전 종료, 저장 후 종료
* [ ] 파일 없음 → 기본 퀴즈 데이터 생성
* [ ] 파일 손상 → 초기화
* [ ] Git 커밋: 예외 처리 구현
...
* [ ] 문제, 선택지 4개, 정답 번호 입력
* [ ] 입력값 검증 (빈값, 범위 초과, 숫자 변환)
* [ ] 추가 후 `state.json` 자동 저장
* [ ] Git 커밋: 퀴즈 추가 기능
